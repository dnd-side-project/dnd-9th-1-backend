...
public record RetrospectResponse(
    ...
    public static RetrospectResponse from(List<RetrospectContent> contents, SuccessLevel successLevel) {
        ...
        return new RetrospectResponse(retrospectContents, successLevel);
    }
}
